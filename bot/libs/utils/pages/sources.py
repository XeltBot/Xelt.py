...
from .paginator import XeltPages


class BasicListSource(menus.ListPageSource):
    """Basic list source for the paginator"""

    async def format_page(self, menu: XeltPages, entries: List[Any]) -> Embed:
...
class FieldPageSource(menus.ListPageSource):
    ...
    async def format_page(
        self, menu: XeltPages, entries: list[tuple[Any, Any]]
    ) -> discord.Embed:
...
class TextPageSource(menus.ListPageSource):
    ...
    async def format_page(self, menu: XeltPages, content: str):
        """Formats the given page

        Args:
            menu (XeltPages): Default menu passed in
...
class EmbedListSource(menus.ListPageSource):
    ...
    async def format_page(
        self, menu: XeltPages, entries: Dict[str, Any]
    ) -> discord.Embed:
